...
Player.prototype.removeEventListener = function (callback) {
...
Player.prototype.dispatchVideoErrorEvent = function (error) {
  this.dispatchEvent("onVideoError", error);
};
...
Player.prototype.appendBuffer = function (arrayBuffer, sourceBuffer) {
  if (this.video.error) {
    this.dispatchVideoErrorEvent(
      new Error("Video Error: " + this.video.error.message)
    );
    return;
  }
  return new Promise(function (resolve) {
