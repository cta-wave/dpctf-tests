...
| `frame_presented_tolerance`| Defines the tolerance for the observations of the start and end of a frame being presented, in seconds. This is used by the observation framework for the playback-rates tests.                                                                                                                                                                                                                                                           |
...
| `rate_step`                | The duration of nominal media time for which each playback rate in a rate sequence is applied before the next rate takes over, in seconds. Used by the playback-rates tests.                                                                                                                                                                                                                                                              |
| `rates`                    | The ordered list of playback rates a playback-rates test applies one after another, e.g. `[1.0, 1.1, 0.9]`. Each rate is held for `rate_step` of media time.                                                                                                                                                                                                                                                                             |
