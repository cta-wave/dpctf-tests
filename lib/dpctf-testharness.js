function DpctfTest(config) {
  ...
  function finishTest() {
    if (resolveWaitingStateSubTest) resolveWaitingStateSubTest();
    done();
  }

  function addWaitingStateSubTest() {
    var maxWaitingStates = parameters.maxWaitingStates || 10;
