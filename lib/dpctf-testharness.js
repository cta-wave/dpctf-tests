...
test = function (func, name) {
  ...
  return oldTest(func, name);
}
var oldAsyncTest = async_test;
async_test = function(func, name) {
  console.log("new async test here!", name);
  return oldAsyncTest(func, name);
}
var oldPromiseTest = promise_test;
promise_test = function(func, name) {
  console.log("new promise test here!", name);
  return oldPromiseTest(func, name);
}
