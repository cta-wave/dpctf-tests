...
(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : ((global = global || self),
      factory((global.mpdParser = {}), global.window, global.window));
})(this, function (exports, window$2, xmldom) {
  "use strict";

  window$2 =
    window$2 && window$2.hasOwnProperty("default")
      ? window$2["default"]
      : window$2;
  ...
  var resolveUrl = function resolveUrl(baseUrl, relativeUrl) {
    ...
    if (!/\/\//i.test(baseUrl)) {
      baseUrl = URLToolkit.buildAbsoluteURL(
  ...
  var segmentRange = {
    ...
    dynamic: function dynamic(attributes) {
      var NOW = attributes.NOW,
        ...
        timescale =
          _attributes$timescale2 === void 0 ? 1 : _attributes$timescale2,
      ...
      var availableStart = Math.floor(
        ((now - periodStartWC - timeShiftBufferDepth) * timescale) / duration
      );
      var availableEnd = Math.floor(
        ((now - periodStartWC) * timescale) / duration
      );
      return {
  ...
  var toSegments = function toSegments(attributes) {
    return function (number, index) {
      var duration = attributes.duration,
        ...
        timescale =
          _attributes$timescale3 === void 0 ? 1 : _attributes$timescale3,
  ...
  var parseByDuration = function parseByDuration(attributes) {
    ...
    if (type === "static") {
      ...
      segments[index].duration =
        sourceDuration - (duration / timescale) * index;
    }
  ...
  var segmentsFromBase = function segmentsFromBase(attributes) {
    var baseUrl = attributes.baseUrl,
      ...
      initialization =
        _attributes$initializ === void 0 ? {} : _attributes$initializ,
      sourceDuration = attributes.sourceDuration,
      _attributes$timescale = attributes.timescale,
      timescale = _attributes$timescale === void 0 ? 1 : _attributes$timescale,
      _attributes$indexRang = attributes.indexRange,
      indexRange =
        _attributes$indexRang === void 0 ? "" : _attributes$indexRang,
  ...
  var addSegmentsToPlaylist = function addSegmentsToPlaylist(
    playlist,
    sidx,
    baseUrl
  ) {
  ...
  var mergeDiscontiguousPlaylists = function mergeDiscontiguousPlaylists(
    playlists
  ) {
    var mergedPlaylists = values(
      playlists.reduce(function (acc, playlist) {
        ...
        if (acc[name]) {
          ...
          (_acc$name$segments = acc[name].segments).push.apply(
            _acc$name$segments,
            playlist.segments
    ...
    return mergedPlaylists.map(function (playlist) {
      playlist.discontinuityStarts = findIndexes(
        playlist.segments,
        "discontinuity"
      );
      return playlist;
  ...
  var addSegmentInfoFromSidx = function addSegmentInfoFromSidx(
    playlists,
    sidxMapping
  ) {
    ...
    for (var i in playlists) {
      ...
      var sidxKey =
        playlist.sidx.uri + "-" + byteRangeToString(playlist.sidx.byterange);
  ...
  var toM3u8 = function toM3u8(dashPlaylists, sidxMapping) {
    ...
    var _dashPlaylists$0$attr = dashPlaylists[0].attributes,
      ...
      minimumUpdatePeriod =
        _dashPlaylists$0$attr2 === void 0 ? 0 : _dashPlaylists$0$attr2;
    ...
    var audioOnly = function audioOnly(_ref5) {
      ...
      return (
        attributes.mimeType === "audio/mp4" ||
        attributes.contentType === "audio"
      );
    };
    ...
    var master = {
      ...
      mediaGroups:
        ...
        (_mediaGroups["CLOSED-CAPTIONS"] = {}),
        (_mediaGroups.SUBTITLES = {}),
        _mediaGroups),
      uri: "",
      duration: duration,
    ...
    if (audioPlaylists.length) {
      master.mediaGroups.AUDIO.audio = organizeAudioPlaylists(
        audioPlaylists,
        sidxMapping
      );
    }
    ...
    if (vttPlaylists.length) {
      master.mediaGroups.SUBTITLES.subs = organizeVttPlaylists(
        vttPlaylists,
        sidxMapping
      );
    }
  ...
  var parseByTimeline = function parseByTimeline(attributes, segmentTimeline) {
    var _attributes$type = attributes.type,
      ...
      minimumUpdatePeriod =
        _attributes$minimumUp2 === void 0 ? 0 : _attributes$minimumUp2,
  ...
  var segmentsFromTemplate = function segmentsFromTemplate(
    attributes,
    segmentTimeline
  ) {
    var templateValues = {
    ...
    return segments.map(function (segment) {
      ...
      var chunks = segment.chunks.map(function (chunk) {
        ...
        return {
          uri: chunkUri,
          number: chunk.number,
          resolvedUri: resolveUrl_1(attributes.baseUrl || "", chunkUri),
        }
      });
  ...
  var SegmentURLToSegmentObject = function SegmentURLToSegmentObject(
    attributes,
    segmentUrl
  ) {
    var baseUrl = attributes.baseUrl,
  ...
  var segmentsFromList = function segmentsFromList(
    attributes,
    segmentTimeline
  ) {
    var duration = attributes.duration,
      ...
      segmentUrls =
        _attributes$segmentUr === void 0 ? [] : _attributes$segmentUr; // Per spec (5.3.9.2.1) no way to determine segment duration OR
    ...
    var segments = segmentTimeInfo
      .map(function (segmentTime, index) {
  ...
  var generateSegments = function generateSegments(_ref) {
    ...
    if (segmentAttributes.duration) {
      var _segmentAttributes = segmentAttributes,
        ...
        timescale =
          _segmentAttributes$ti === void 0 ? 1 : _segmentAttributes$ti;
  ...
  var buildBaseUrls = function buildBaseUrls(referenceUrls, baseUrlElements) {
    ...
    return flatten(
      referenceUrls.map(function (reference) {
  ...
  var getSegmentInformation = function getSegmentInformation(adaptationSet) {
    ...
    var segmentUrls =
      segmentList &&
      findChildren(segmentList, "SegmentURL").map(function (s) {
        return merge(
          {
            tag: "SegmentURL",
          },
    ...
    var segmentInitializationParentNode =
      segmentList || segmentBase || segmentTemplate;
    var segmentInitialization =
      segmentInitializationParentNode &&
      findChildren(segmentInitializationParentNode, "Initialization")[0]; // SegmentTemplate is handled slightly differently, since it can have both
    ...
    var segmentInfo = {
      ...
      timeline:
        segmentTimeline &&
        findChildren(segmentTimeline, "S").map(function (s) {
          return parseAttributes(s);
        }),
      list:
        segmentList &&
        merge(parseAttributes(segmentList), {
          segmentUrls: segmentUrls,
          initialization: parseAttributes(segmentInitialization),
        }),
      base:
        segmentBase &&
        merge(parseAttributes(segmentBase), {
          initialization: parseAttributes(segmentInitialization),
        }),
    };
  ...
  var generateKeySystemInformation = function generateKeySystemInformation(
  ...
  var toRepresentations = function toRepresentations(
    periodAttributes,
    periodBaseUrls,
    periodSegmentInfo
  ) {
    return function (adaptationSet) {
      ...
      var adaptationSetBaseUrls = buildBaseUrls(
        periodBaseUrls,
      ...
      var contentProtection = generateKeySystemInformation(
  ...
  var toAdaptationSets = function toAdaptationSets(mpdAttributes, mpdBaseUrls) {
    return function (period, index) {
      var periodBaseUrls = buildBaseUrls(
        mpdBaseUrls,
        findChildren(period, "BaseURL")
      );
  ...
  var inheritAttributes = function inheritAttributes(mpd, options) {
    ...
    var _options = options,
      ...
      clientOffset =
        _options$clientOffset === void 0 ? 0 : _options$clientOffset;
  ...
  var stringToMpdXml = function stringToMpdXml(manifestString) {
    ...
    var mpd =
      xml && xml.documentElement.tagName === "MPD" ? xml.documentElement : null;
  ...
  var parse = function parse(manifestString, options) {
    ...
    return toM3u8(
      toPlaylists(inheritAttributes(stringToMpdXml(manifestString), options)),
      options.sidxMapping
    );
  };
  /**
