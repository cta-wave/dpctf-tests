...
var Player = function (video) {
  ...
  this.isBufferingVideoSegment = false;
...
Player.prototype.bufferSegment = function (segment) {
  ...
  var isRepresentationChange =
    segment.getRepresentationNumber() !== this.bufferingRepresentationNumber;
  ...
  return new Promise(function (resolve, reject) {
    ...
    self.bufferingRepresentationNumber = segment.getRepresentationNumber();
    ...
    return new Promise(function (resolve) {
      self.fetchSegment(segmentUrl).then(function (arrayBuffer) {
        self.appendVideoBuffer(arrayBuffer).then(function () {
          self.isBufferingVideoSegment = false;
